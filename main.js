...
const words = ['любимая', 'котик','любимка', 'котёнок', 'звёздочка', 'кити', 'зайка', 'Николенька', 'Николька', 'киса', 'любимочка', 'леди', 'милая', 'звёздочка','королева', 'золотце', 'котейка', 'Николечка', 'дорогая', 'самая самая']
let interval;
